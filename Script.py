...
➻ ᴛʜɪꜱ ʙᴏᴛ ᴀʟꜱᴏ ꜱᴜᴘᴘᴏʀᴛꜱ ᴄᴜꜱᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ ᴀɴᴅ ᴄᴜꜱᴛᴏᴍ ᴄᴀᴘᴛɪᴏɴ."""
    ...
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: RENAMER BOT 
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/God_Luffy_ATI>꧁𓊈𒆜. ɪᴛ'ꜱ ʟᴜғғʏ 𒆜𓊉꧂</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
...
ᴘʀɪᴄᴇ: ₹99 ᴘᴇʀ ᴍᴏɴᴛʜ"""
    ...
    UPGRADE_PLAN_TXT = """**Fʀᴇᴇ Pʟᴀɴ Usᴇʀs**
Dᴀɪʟʏ Uᴘʟᴏᴀᴅ ʟɪᴍɪᴛ 𝟻GB Rᴇɴᴀᴍᴇ Oɴʟʏ Uᴘᴛᴏ 𝟸ɢʙ Fɪʟᴇs
Pʀɪᴄᴇ 𝟶
 
**🥈 Sɪʟᴠᴇʀ Pʟᴀɴ 🥈**
Dᴀɪʟʏ  Uᴘʟᴏᴀᴅ  ʟɪᴍɪᴛ : 𝟸𝟶GB
Pʀɪᴄᴇ Rs 𝟷𝟿  
Vᴀʟɪᴅɪᴛʏ: 𝟹𝟶ᴅᴀʏs
